...
description: "Subagent implementujący zmiany w warstwie UI (React/TypeScript). Użyj gdy masz gotowy plan zmian i potrzebujesz kogoś do modyfikacji komponentów, hooków lub typów."
model: inherit
is_background: false
---
...
```
Wykonaj zmiany opisane w .opencode/subagents/rules/{feature}-ui-fix-{nn}.md
```

## Zasady pracy

### Przed każdą zmianą
Użyj Grep, Glob i Read żeby znaleźć istniejące wzorce.
...
// Sprawdź jak inne komponenty obsługują błędy przez Grep, Glob i Read
...
**Formularze:**
```typescript
// Sprawdź przez Grep, Glob i Read jak inne formularze są zbudowane
