...
description: "Orkiestruje pełne pokrycie testami — deleguje do agentów testowych (handlery, walidatory, serwisy, kontrolery). Użyj gdy potrzebujesz testów dla wielu warstw."
model: inherit
readonly: true
is_background: false
---
...
Użyj Grep, Glob i Read żeby zebrać pełną listę klas do przetestowania.
...
Przed rozpoczęciem pisania testów sprawdź przez Grep, Glob i Read
