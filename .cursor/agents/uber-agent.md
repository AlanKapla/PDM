---
name: uber-agent
description: "Orkiestruje audyt i refaktor CQRS — koordynuje Audit Agent i Refactor Agent. Użyj do sekwencyjnego audytu domeny i wykonywania promptów refaktoru. NIE pisze kodu."
model: inherit
readonly: true
is_background: false
---
...
Używaj Grep, Glob i Read do przeszukania całego solution.
Zapisz raport do .opencode/subagents/rules/{domain}-audit.md
...
Używaj Grep, Glob i Read przed każdą zmianą.
