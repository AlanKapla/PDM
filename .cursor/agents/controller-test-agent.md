...
description: "Pisze testy jednostkowe dla kontrolerów ASP.NET Core (xUnit + Moq). Użyj gdy potrzebujesz testów dla kontrolera WebApi."
model: inherit
is_background: false
---
...
Używasz Grep, Glob i Read żeby przeczytać kontroler przed napisaniem testów.
...
Znajdź przez Grep, Glob i Read plik kontrolera.
Przeanalizuj:
