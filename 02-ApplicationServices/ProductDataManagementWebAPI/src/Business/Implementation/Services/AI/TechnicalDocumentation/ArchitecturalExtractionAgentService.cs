...
public sealed class ArchitecturalExtractionAgentService : IArchitecturalExtractionAgent
{
    ...
    private readonly ILogger<ArchitecturalExtractionAgentService> logger;

    public ArchitecturalExtractionAgentService(
        IAICompletionService completionService,
        AgentDefinitionLoader agentDefinitionLoader,
        ILogger<ArchitecturalExtractionAgentService> logger)
    {
