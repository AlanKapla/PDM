...
namespace Business.Implementation.Helpers
{
    ...
    public static class DefaultCostEstimateFieldSchemaFactory
    {
        ...
        [
            ...
            new("unitPriceNet", "Cena jednostkowa netto", CostEstimateFieldType.UnitPriceNet, false),
            new("vatRate", "Stawka VAT", CostEstimateFieldType.VatRate, false),
            new("unitPriceGross", "Cena jednostkowa brutto", CostEstimateFieldType.UnitPriceGross, false),
