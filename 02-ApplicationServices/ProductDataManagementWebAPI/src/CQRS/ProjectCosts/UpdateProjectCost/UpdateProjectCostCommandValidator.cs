...
{
    public sealed class UpdateProjectCostCommandValidator : AbstractValidator<UpdateProjectCostCommand>
    {
        public UpdateProjectCostCommandValidator()
        {
            ...
            this.ApplyDocumentRules(x => x.UpdatedDocument, "UpdatedDocument");
