...
- Czytaj skill przed każdą delegacją: `.opencode/skills/brickly-landing/SKILL.md`

## Workflow

### Krok 1 — Analiza wymagań
Przeczytaj `.opencode/skills/brickly-landing/SKILL.md` i zrozum zakres zmian.
...
Zasady: bezosobowy, profesjonalny język. Skill: .opencode/skills/brickly-landing/SKILL.md
```
