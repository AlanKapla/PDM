...
| Moduł | Wywołanie |
|-------|-----------|
| Uprawnienia | `@permissions-test-agent Wygeneruj przypadki testowe dla uprawnień. Czytaj kod przez #codebase. Zapisz do .github/testCases/test-cases-permissions.md` |
| Współpraca | `@project-collaboration-test-agent Wygeneruj przypadki testowe dla współpracy projektowej. Czytaj kod przez #codebase. Zapisz do .github/testCases/test-cases-collaboration.md` |
| Kosztorysy | `@cost-estimate-test-agent Wygeneruj przypadki testowe dla kosztorysów. Czytaj kod przez #codebase. Zapisz do .github/testCases/test-cases-cost-estimates.md` |
| Harmonogramy | `@work-schedule-test-agent Wygeneruj przypadki testowe dla harmonogramów. Czytaj kod przez #codebase. Zapisz do .github/testCases/test-cases-work-schedules.md` |
| Synchronizacja | `@sync-test-agent Wygeneruj przypadki testowe dla synchronizacji. Czytaj kod przez #codebase. Zapisz do .github/testCases/test-cases-sync.md` |
| Wiadomości | `@messages-test-agent Wygeneruj przypadki testowe dla modułu wiadomości. Czytaj kod przez #codebase. Zapisz do .github/testCases/test-cases-messages.md` |
| Pliki | `@files-test-agent Wygeneruj przypadki testowe dla modułu plików. Czytaj kod przez #codebase. Zapisz do .github/testCases/test-cases-files.md` |
| Dashboard | `@dashboard-costs-test-agent Wygeneruj przypadki testowe dla dashboardu i kosztów. Czytaj kod przez #codebase. Zapisz do .github/testCases/test-cases-dashboard-costs.md` |
...
`.github/testCases/test-cases-index.md`
...
Indeks: `.github/testCases/test-cases-index.md`
